  ...
  function renderBookingStep4(state) {
    ...
    return `
      <div class="max-w-2xl mx-auto px-4 sm:px-6 pt-4 sm:pt-8 pb-28 sm:pb-12 space-y-6 text-left animate-fadeIn">
        ...
        <div class="bg-transparent sm:bg-[#FFF7E8] rounded-none sm:rounded-3xl border-0 sm:border sm:border-[#EADFD1] shadow-none sm:shadow-2xl p-0 sm:p-8 space-y-6 flex flex-col items-center text-center">
